export const translations = {
  en: {
    ...
    contactError: 'We could not send your message right now. Please try again or contact us directly.',
    contactEmailNow: 'Email us now',
  ...
  es: {
    ...
    contactError: 'No pudimos enviar tu mensaje en este momento. Intenta nuevamente o contáctanos directamente.',
